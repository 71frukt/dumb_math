...
Основа метода — линейное преобразование (на базе разложения Холецкого для ковариационной матрицы) двух независимых стандартных нормальных величин $Z_1, Z_2 \sim M(0, 1)$, которые формируются с помощью ранее реализованного генератора нормального распределения.
